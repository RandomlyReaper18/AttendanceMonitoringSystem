...
import com.mycompany.login.JFRAME.LoginInterface;
...
public class Signup extends javax.swing.JFrame {
    ...
    private void makeSignupLayoutResizable() {
    // Find the card panel dynamically — it's the only child jPanel3 has.
        javax.swing.JPanel card = null;
        for (java.awt.Component c : jPanel3.getComponents()) {
            if (c instanceof TranslucentCardPanel) {
                card = (javax.swing.JPanel) c;
                break;
            }
        }
        if (card == null) {
            System.err.println("Could not locate the sign-up card panel.");
            return;
        }

        // ---- Content pane: both sides resize with the window ----
        ...
        // ---- jPanel3: the sign-up card floats centered, fixed size ----
        ...
        // ---- jPanel1: table grows with its side of the window ----
    ...
    private void initComponents() {
        ...
        javax.swing.JPanel jPanel2 = new com.mycompany.login.TranslucentCardPanel();
